...
namespace TechShop.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult OrderHistory()
        {
            ...
            model.UserID = userId;
            //model.UserID = userId;
            model.Orders = OrdersService.Instance.SearchOrdersByUser(userId);
        ...
        //
        // GET: /Manage/UpdateUserAccount
        [HttpGet]
        [Authorize]
        public ActionResult UpdateUserAccount()
        {
        ...
        //
        // POST: /Manage/UpdateUserAccount
        [HttpPost]
        [Authorize]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> UpdateUserAccount(UpdateAccountViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
